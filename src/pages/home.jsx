...
export default function Home() {
    return (
        <>
            ...
            <div className="h-1 m white"><div className="fheavy h1">Dev.코체</div><div className="fmedium h3">안녕하세요!<br />저는 학생 개발자 코체라고 해요!</div> </div>
            <a href="#h-a"><div className="h-tp_ h-tp1_" /></a>
            <div className="h-2" id="h-a">
                <div className="h-top">　</div>
                <div className="h-2 fbold h2 m">저는 이런사람 이에요</div>
                <div className="h-2_button">
                    <div className="h-2_button_group h-2_button_group_1">
                        <div className="h-2_button_box mh">
                            ...
                            <div className="h-2_button_box_title fmedium h3 m">노력하는</div>
                            <div className="h-2_button_box_subtitle fregular h5 m">만족 할때까지<br />최선을 다해 노력해요!</div>
                        </div>
                        <div className="h-2_button_box mh">
                            <img className="h-2_button_box_img h-st-2" src={homebox_02} alt="사서고생하는"/>
                            <div className="h-2_button_box_title fmedium h3 m">사서고생하는</div>
                            <div className="h-2_button_box_subtitle fregular h5 m">제가 하고싶은 일이라면<br />고생을 사서라도 합니다!</div>
                        </div>
                    </div>
                    <div className="h-2_button_group h-2_button_group_2">
                        <div className="h-2_button_box mh">
                            <img className="h-2_button_box_img h-st-3" src={homebox_03} alt="다양한"/>
                            <div className="h-2_button_box_title fmedium h3 m">다양한</div>
                            <div className="h-2_button_box_subtitle fregular h5 m">여러가지를 만들고 싶어요!</div>
                        </div>
                        <div className="h-2_button_box mh">
                            <img className="h-2_button_box_img h-st-4" src={homebox_04} alt="배워가는"/>
                            <div className="h-2_button_box_title fmedium h3 m">배워가는</div>
                            <div className="h-2_button_box_subtitle fregular h5 m">더 많은걸 만들기 위해<br />여러가지를 배우고 싶어요!</div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="h-3" id="h-b">
                <div className="h-top">　</div>
                <div className="h-3_title fbold h2 m">진행중인 프로젝트들을<br />만나보세요</div>
            ...
            <div className="h-4_box">
                ...
                <div className="h-absolute">
                    ...
                    <div className="h-4_text">
                        <div className="h-4_title h2 m white fmedium">제게 연락하는 방법이에요</div>
                        <div className="h-4_subtitle h4 m white flight">이곳으로 연락해야 제가 확인할 수 있어요</div>
                    </div>
                </div>
            </div>
        </>
